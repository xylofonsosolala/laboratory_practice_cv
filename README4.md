...
На вход подается зашумленное изображение RGB (28*28*3). Дальше идут свертки (convolution) и pooling и получаем сжатое представление (7*7*64)
...
Сверточный слой выделяет на изображении характерные примитивы. 
